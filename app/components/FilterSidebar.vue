<template>
  <div class="w-72">
    ...
    <div class="flex flex-col gap-2 mt-4">
      ...
      <select
        v-model="sortBy"
        class="w-full px-2 py-1 rounded bg-gray-700 border border-gray-600 text-sm"
      >
    ...
    <button
      class="w-full mt-6 px-3 py-2 rounded bg-gray-700 hover:bg-gray-600 text-sm font-medium"
      @click="clearFilters"
    >
      Clear All Filters
    </button>
