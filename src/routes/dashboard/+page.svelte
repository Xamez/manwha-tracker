  ...
  <main class="main-content">
    <div class="container">
      ...
      <div class="stats-grid">
        <StatsCard title="Currently Reading" value={data.stats.reading} icon="reading" color="green" />
        <StatsCard title="Completed" value={data.stats.completed} icon="completed" color="blue" />
        <StatsCard title="To Continue" value={data.stats.toContinue} icon="planned" color="orange" />
        <StatsCard title="Total Manwhas" value={data.stats.total} icon="book" color="purple" />
      </div>
